...
- Name: offline-online.spec.js >> Offline / online behavior >> search works with no network once the Bible is cached
- Location: tests/offline-online.spec.js:95:3

# Error details

```
Error: page.goto: net::ERR_INTERNET_DISCONNECTED at http://localhost:4173/search
Call log:
  - navigating to "http://localhost:4173/search", waiting until "load"
