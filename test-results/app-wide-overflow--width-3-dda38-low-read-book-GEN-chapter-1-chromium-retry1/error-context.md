...
- Name: app-wide-overflow.spec.js >> [width 360px] >> no horizontal overflow: /read?book=GEN&chapter=1
- Location: tests/app-wide-overflow.spec.js:63:7

# Error details

```
Error: /read?book=GEN&chapter=1 @ 360px overflows horizontally by 0px:
