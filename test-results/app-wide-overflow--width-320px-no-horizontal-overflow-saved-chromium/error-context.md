...
- Name: app-wide-overflow.spec.js >> [width 320px] >> no horizontal overflow: /saved
- Location: tests/app-wide-overflow.spec.js:63:7

# Error details

```
Error: /saved @ 320px overflows horizontally by 0px:
  <button class="flex items-center gap-2 px-4 py-2 rounded-full font-sans text-sm font-medium whi"> "New Folder" (over by 16px)
...
+ Array [
+   Object {
+     "cls": "flex items-center gap-2 px-4 py-2 rounded-full font-sans text-sm font-medium whi",
+     "overBy": 16,
+     "tag": "button",
+     "text": "New Folder",
+   },
...
- generic [ref=e2]:
  - generic [ref=e3]:
    ...
    - main [ref=e19]:
      - generic [ref=e23]:
        - generic [ref=e24]:
          - heading "Saved Verses" [level=1] [ref=e28]
          - paragraph [ref=e29]: 0 verses saved
        - generic [ref=e31]:
          - button "All" [ref=e32] [cursor=pointer]
          - button "Favorites" [ref=e34] [cursor=pointer]
          - button "New Folder" [ref=e37] [cursor=pointer]
        - generic [ref=e40]:
          - paragraph [ref=e43]: No saved verses yet
          - paragraph [ref=e44]: Tap any verse while reading and press the bookmark icon to save it.
          - button "Start Reading" [ref=e45] [cursor=pointer]
    - navigation [ref=e48]:
      - generic [ref=e50]:
        - button "Home" [ref=e51] [cursor=pointer]
        - button "Contents" [ref=e56] [cursor=pointer]
        - button "Read" [ref=e59] [cursor=pointer]
        - button "Gospel" [ref=e63] [cursor=pointer]
        - button "Toggle navigation rows" [ref=e67] [cursor=pointer]
