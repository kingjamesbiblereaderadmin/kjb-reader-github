...
- Name: app-wide-overflow.spec.js >> [width 360px] >> no horizontal overflow: /landing
- Location: tests/app-wide-overflow.spec.js:63:7

# Error details

```
Error: /landing @ 360px overflows horizontally by 0px:
  ...
  - generic [ref=e11]:
    - generic [ref=e12]:
      - link [ref=e13] [cursor=pointer]:
        - /url: /
        - img "KJB Reader Logo" [ref=e14]
      - heading "Welcome to KJB Reader" [level=1] [ref=e15]
      - paragraph [ref=e16]: KJB Reader is a free, installable Bible reading app featuring the King James Bible (Pure Cambridge Edition). Enjoy offline reading, search, bookmarks, and customizable typography — all with privacy at the forefront.
    - generic [ref=e18]:
      - paragraph [ref=e21]: 2 Timothy 2:15
      - blockquote [ref=e23]: "\"Study to shew thyself approved unto God, a workman that needeth not to be ashamed, rightly dividing the word of truth.\""
    - link [ref=e25] [cursor=pointer]:
      - /url: /salvation
      - generic [ref=e29]:
        - paragraph [ref=e30]: Are you saved?
        - paragraph [ref=e31]: Jesus Christ died, shed his blood, was buried, and rose again on the third day for our sins. Trust Christ's blood, death, burial and resurrection for your sins, and be eternally saved.
    - link [ref=e35] [cursor=pointer]:
      - /url: /espanol-evangelio
      - generic [ref=e40]:
        - paragraph [ref=e41]: Are you saved? (Español)
        - paragraph [ref=e42]: El Evangelio de Salvación
    - generic [ref=e46]:
      - generic [ref=e47]:
        - button "Install" [ref=e48] [cursor=pointer]
        - button "Theme" [ref=e55] [cursor=pointer]
        - button "Fonts" [ref=e65] [cursor=pointer]
        - button "Layout" [ref=e71] [cursor=pointer]
        - button "Explore" [ref=e77] [cursor=pointer]
      - generic [ref=e84]:
        - heading "Install the App" [level=3] [ref=e85]
        - paragraph [ref=e86]: Get offline access and faster loading
        - paragraph [ref=e88]: You're in a private window. App install and notifications won't work, and settings will be erased when you close this window.
        - paragraph [ref=e89]: You can install the app later from Settings.
      - generic [ref=e90]:
        - button "Back" [disabled]
        - button "Next" [ref=e91] [cursor=pointer]
    - button "Legal & Legacy" [ref=e96] [cursor=pointer]
    - button "Contact" [ref=e104] [cursor=pointer]
    - paragraph [ref=e112]: "© 2026 KJB Reader · Last updated: September 3rd, 2026"
