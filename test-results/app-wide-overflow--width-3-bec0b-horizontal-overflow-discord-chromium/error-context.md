...
- Name: app-wide-overflow.spec.js >> [width 320px] >> no horizontal overflow: /discord
- Location: tests/app-wide-overflow.spec.js:63:7

# Error details

```
Error: /discord @ 320px overflows horizontally by 0px:
...
- generic [ref=e2]:
  - generic [ref=e3]:
    ...
    - generic [ref=e8]:
      - link "Back to KJB Reader" [ref=e9] [cursor=pointer]:
        - /url: /
      - generic [ref=e12]:
        - heading "KJB Reader Bot" [level=1] [ref=e16]
        - paragraph [ref=e17]: For random, search, daily, and gospel sharing.
      - generic [ref=e19]:
        - link [ref=e20] [cursor=pointer]:
          - /url: https://discord.com/oauth2/authorize?client_id=1529303667348606996&scope=applications.commands&integration_type=1
          - generic [ref=e25]:
            - paragraph [ref=e26]: 📱 Personal Install
            - paragraph [ref=e27]: Adds slash commands to your Discord account — works in DMs, group DMs, and any server.
        - link [ref=e28] [cursor=pointer]:
          ...
          - generic [ref=e33]:
            - paragraph [ref=e34]: 🏠 Server Install
            - paragraph [ref=e35]: Install for looking up verses, chapters, and the gospel on your servers.
      - generic [ref=e36]:
        - link [ref=e37] [cursor=pointer]:
          - /url: https://kingjamesbiblereader.com/discord
          - generic [ref=e41]:
            - paragraph [ref=e42]: Support Server
            - paragraph [ref=e43]: Join our Discord community for help, updates, and to share feedback.
        - link [ref=e46] [cursor=pointer]:
          - /url: mailto:Kingjamesbiblereader@outlook.sg
          - generic [ref=e51]:
            - paragraph [ref=e52]: Support Email
            - paragraph [ref=e53]: Kingjamesbiblereader@outlook.sg
      - generic [ref=e56]:
        - heading "Built With" [level=2] [ref=e57]
        - list [ref=e58]:
          - listitem [ref=e59]:
            - link "King James Bible (KJB) text" [ref=e60] [cursor=pointer]:
              - /url: https://bibleprotector.com
            - generic [ref=e61]: — public domain, 1900 Pure Cambridge Edition, sourced from Bible Protector.
          - listitem [ref=e62]:
            - link "Discord.js" [ref=e63] [cursor=pointer]:
              - /url: https://discord.js.org
            - generic [ref=e64]: — open-source Node.js library (MIT licence) powering the bot's Discord integration.
          - listitem [ref=e65]:
            - link "Discloud" [ref=e66] [cursor=pointer]:
              - /url: https://discloud.app
            - generic [ref=e67]: — hosting provider running the bot's always-on Discord gateway connection.
          - listitem [ref=e68]:
            - link "KJB Reader Bible API (kingjamesbiblereader.com)" [ref=e69] [cursor=pointer]:
              - /url: https://kingjamesbiblereader.com
            - generic [ref=e70]: — the API powering verse lookup and search.
          - listitem [ref=e71]:
            - link "node-cron" [ref=e72] [cursor=pointer]:
              - /url: https://github.com/node-cron/node-cron
            - generic [ref=e73]: — open-source scheduling library used for daily verse delivery timing.
