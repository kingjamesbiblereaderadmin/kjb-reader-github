...
- Name: app-wide-overflow.spec.js >> [width 320px] >> no horizontal overflow: /read?book=1KI&chapter=16
- Location: tests/app-wide-overflow.spec.js:63:7

# Error details

```
Error: /read?book=1KI&chapter=16 @ 320px overflows horizontally by 0px:
