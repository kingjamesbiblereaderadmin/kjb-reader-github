...
- Name: app-wide-overflow.spec.js >> [width 320px] >> no horizontal overflow: /advanced-search
- Location: tests/app-wide-overflow.spec.js:63:7

# Error details

```
Error: /advanced-search @ 320px overflows horizontally by 0px:
  <div class="kjb-slide-forward"> "Advanced SearchResearch the King James Bible by verse proper" (over by 2.2px)
