...
- Name: layout-regression.spec.js >> [narrow-phone 360x780] >> 1 Kings 16 (longest OT title) — serif @ 200%
- Location: tests/layout-regression.spec.js:72:11

# Error details

```
Error: 1 Kings 16 (longest OT title) (serif @ 200%): text leaking across the column divider:
  "T" (left column, over by 25px)
