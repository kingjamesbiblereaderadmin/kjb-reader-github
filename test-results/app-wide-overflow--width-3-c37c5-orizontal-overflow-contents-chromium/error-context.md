...
- Name: app-wide-overflow.spec.js >> [width 320px] >> no horizontal overflow: /contents
- Location: tests/app-wide-overflow.spec.js:63:7

# Error details

```
Error: /contents @ 320px overflows horizontally by 0px:
...
- generic [ref=e2]:
  ...
  - generic [ref=e10]:
    ...
    - main [ref=e26]:
      - generic [ref=e30]:
        - generic [ref=e31]:
          - heading "Table of Contents" [level=1] [ref=e34]
          - paragraph [ref=e35]: King James Bible — Pure Cambridge Edition
        - button "Select a Book" [ref=e38] [cursor=pointer]
        - paragraph [ref=e42]: Tap "Select a Book" to choose a book, chapter, and verse
    - navigation [ref=e43]:
      - generic [ref=e45]:
        - button "Home" [ref=e46] [cursor=pointer]
        - button "Contents" [ref=e51] [cursor=pointer]
        - button "Read" [ref=e55] [cursor=pointer]
        - button "Gospel" [ref=e59] [cursor=pointer]
        - button "Toggle navigation rows" [ref=e63] [cursor=pointer]
