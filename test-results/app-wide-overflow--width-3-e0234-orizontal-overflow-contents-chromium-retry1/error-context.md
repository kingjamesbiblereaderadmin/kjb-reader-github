...
- Name: app-wide-overflow.spec.js >> [width 360px] >> no horizontal overflow: /contents
...
- generic [ref=e2]:
  - generic [ref=e3]:
    ...
    - main [ref=e19]:
      - generic [ref=e23]:
        - generic [ref=e24]:
          - heading "Table of Contents" [level=1] [ref=e27]
          - paragraph [ref=e28]: King James Bible — Pure Cambridge Edition
        - button "Select a Book" [ref=e31] [cursor=pointer]
        - paragraph [ref=e35]: Tap "Select a Book" to choose a book, chapter, and verse
    - navigation [ref=e36]:
      - generic [ref=e38]:
        - button "Home" [ref=e39] [cursor=pointer]
        - button "Contents" [ref=e44] [cursor=pointer]
        - button "Read" [ref=e48] [cursor=pointer]
        - button "Gospel" [ref=e52] [cursor=pointer]
        - button "Toggle navigation rows" [ref=e56] [cursor=pointer]
