...
- Name: layout-regression.spec.js >> [phone 393x851] >> 1 Kings 16 (longest OT title) — cursive @ 250%
...
Error: 1 Kings 16 (longest OT title) (cursive @ 250%): text leaking across the column divider:
  "T" (left column, over by 22.8px)
  "Forasmuch as I exalted thee out of the d" (left column, over by 10.8px)
  "Forasmuch as I exalted thee out of the d" (left column, over by 3.8px)
  "Forasmuch as I exalted thee out of the d" (left column, over by 3.8px)
  "Forasmuch as I exalted thee out of the d" (left column, over by 3.8px)
  "Forasmuch as I exalted thee out of the d" (left column, over by 2.8px)
  "Forasmuch as I exalted thee out of the d" (left column, over by 2.8px)
  "Forasmuch as I exalted thee out of the d" (left column, over by 3.8px)
  "Forasmuch as I exalted thee out of the d" (left column, over by 3.8px)
  "Forasmuch as I exalted thee out of the d" (left column, over by 3.8px)
  "Forasmuch as I exalted thee out of the d" (left column, over by 3.8px)
  "Forasmuch as I exalted thee out of the d" (left column, over by 2.8px)
  "Behold, I will take away the posterity o" (left column, over by 1.8px)
  "Behold, I will take away the posterity o" (left column, over by 2.8px)
  "Behold, I will take away the posterity o" (left column, over by 2.8px)
  "Behold, I will take away the posterity o" (left column, over by 1.8px)
  "Behold, I will take away the posterity o" (left column, over by 2.8px)
  "Behold, I will take away the posterity o" (left column, over by 3.8px)
  "Behold, I will take away the posterity o" (left column, over by 3.8px)
  "Behold, I will take away the posterity o" (left column, over by 3.8px)
  "Him that dieth of Baasha in the city sha" (left column, over by 2.8px)
  "Him that dieth of Baasha in the city sha" (left column, over by 3.8px)
  "Him that dieth of Baasha in the city sha" (left column, over by 1.8px)
  "Him that dieth of Baasha in the city sha" (left column, over by 3.8px)
  "Him that dieth of Baasha in the city sha" (left column, over by 2.8px)
  "So Baasha slept with his fathers, and wa" (left column, over by 1.8px)
  "So Baasha slept with his fathers, and wa" (left column, over by 2.8px)
  "So Baasha slept with his fathers, and wa" (left column, over by 2.8px)
  "And also by the hand of the prophet Jehu" (left column, over by 1.8px)
  "And also by the hand of the prophet Jehu" (left column, over by 2.8px)
  "And also by the hand of the prophet Jehu" (left column, over by 3.8px)
  "And also by the hand of the prophet Jehu" (left column, over by 2.8px)
  "And also by the hand of the prophet Jehu" (left column, over by 2.8px)
  "And also by the hand of the prophet Jehu" (left column, over by 3.8px)
  "And also by the hand of the prophet Jehu" (left column, over by 1.8px)
  ...
  "And also by the hand of the prophet Jehu" (left column, over by 3.8px)
  "And also by the hand of the prophet Jehu" (left column, over by 3.8px)
  "And Zimri went in and smote him, and kil" (left column, over by 1.8px)
  "And Zimri went in and smote him, and kil" (left column, over by 2.8px)
  "And Zimri went in and smote him, and kil" (left column, over by 3.8px)
  "And Zimri went in and smote him, and kil" (left column, over by 2.8px)
  "And Zimri went in and smote him, and kil" (left column, over by 3.8px)
  "And Zimri went in and smote him, and kil" (left column, over by 3.8px)
  "And Zimri went in and smote him, and kil" (left column, over by 3.8px)
  "And Zimri went in and smote him, and kil" (left column, over by 2.8px)
  "And Zimri went in and smote him, and kil" (left column, over by 1.8px)
  "Thus did Zimri destroy all the house of " (left column, over by 2.8px)
  "Thus did Zimri destroy all the house of " (left column, over by 3.8px)
  "Thus did Zimri destroy all the house of " (left column, over by 1.8px)
  "Thus did Zimri destroy all the house of " (left column, over by 2.8px)
  "Thus did Zimri destroy all the house of " (left column, over by 2.8px)
  "Thus did Zimri destroy all the house of " (left column, over by 3.8px)
  "Thus did Zimri destroy all the house of " (left column, over by 2.8px)
  "Thus did Zimri destroy all the house of " (left column, over by 1.8px)
  "For all the sins of Baasha, and the sins" (left column, over by 10.8px)
  "For all the sins of Baasha, and the sins" (left column, over by 1.8px)
  "For all the sins of Baasha, and the sins" (left column, over by 2.8px)
  "For all the sins of Baasha, and the sins" (left column, over by 2.8px)
  "For all the sins of Baasha, and the sins" (left column, over by 3.8px)
  "For all the sins of Baasha, and the sins" (left column, over by 2.8px)
  "For all the sins of Baasha, and the sins" (left column, over by 3.8px)
  "For all the sins of Baasha, and the sins" (left column, over by 2.8px)
  "And Omri went up from Gibbethon, and all" (left column, over by 1.8px)
  "And Omri went up from Gibbethon, and all" (left column, over by 2.8px)
  "And Omri went up from Gibbethon, and all" (left column, over by 3.8px)
  "And Omri went up from Gibbethon, and all" (left column, over by 2.8px)
  "And Omri went up from Gibbethon, and all" (left column, over by 3.8px)
