...
function StepCard({ number, icon, iconBg, title, copyText, children, defaultOpen = false, collapsible = false }) {
  ...
  return (
    <div className="bg-gradient-to-br from-card via-card to-accent/15 border border-accent/25 border-t-4 border-t-rose-300 dark:border-t-rose-700/60 backdrop-blur-xl rounded-2xl p-6 shadow-lg shadow-black/[0.03]">
      ...
      {showSpanishGospelCard && (
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="font-sans text-xs text-muted-foreground">El Evangelio de Salvación</p>
          </div>
