...
export default function AppLayout() {
  ...
  return (
    <AutoUpdateHandler>
    <div className="h-[100dvh] bg-gradient-to-br from-background via-accent/5 to-background flex flex-col overflow-hidden">
        ...
        {menuOpen && (
          <>
            ...
            <div data-kjb-menu className="absolute top-full right-0 left-0 z-50 bg-card backdrop-blur-xl border-b border-border/60 shadow-lg shadow-black/[0.05]">
              ...
              <div className="w-full max-w-[120rem] mx-auto px-5 sm:px-8 lg:px-12 py-4 grid grid-cols-[repeat(auto-fit,minmax(8rem,1fr))] gap-2.5">
                {NAV_ITEMS.map(item => {
