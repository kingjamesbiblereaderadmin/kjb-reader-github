...
export default function ResourcesPage() {
  ...
  return (
    <div className="w-full max-w-[120rem] mx-auto px-5 sm:px-8 lg:px-12 py-10">
      ...
      {/* Ministry Links */}
      <div className="bg-purple-100/60 dark:bg-card border border-purple-200 dark:border-border rounded-2xl mb-6 overflow-hidden">
        <button
          onClick={() => toggleSection('ministry')}
          className="w-full flex items-center justify-between p-5 bg-white/70 dark:bg-secondary/50 hover:bg-white/80 dark:hover:bg-secondary/80 transition-all duration-200 hover:scale-[1.01] active:scale-[0.99] text-left"
        >
          <div>
