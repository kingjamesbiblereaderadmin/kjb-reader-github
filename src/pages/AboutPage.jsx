...
export default function AboutPage() {
  return (
    ...
    <div className="w-full max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 py-10">
      ...
      {/* About Shawn */}
      <div className="notranslate bg-amber-50 dark:bg-amber-950/40 border border-amber-200 dark:border-amber-900/60 rounded-2xl p-7 mb-8 shadow-lg shadow-black/[0.03]" translate="no">
      ...
      <div className="notranslate bg-blue-50 dark:bg-blue-950/40 border border-blue-200 dark:border-blue-900/60 rounded-2xl p-7 mb-8 shadow-lg shadow-black/[0.03]" translate="no">
      ...
      {/* Links */}
      <div className="bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-200 dark:border-emerald-900/60 rounded-2xl p-7 mb-8 shadow-lg shadow-black/[0.03]">
