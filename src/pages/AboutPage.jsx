...
export default function AboutPage() {
  return (
    ...
    <div className="w-full max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 py-10">
      ...
      {/* About Shawn */}
      <div className="notranslate bg-gradient-to-br from-card via-card to-accent/15 border border-accent/25 backdrop-blur-xl rounded-2xl p-7 mb-8 shadow-lg shadow-black/[0.03] border-t-4 border-t-amber-300 dark:border-t-amber-700/60" translate="no">
      ...
      <div className="notranslate bg-gradient-to-br from-card via-card to-accent/15 border border-accent/25 backdrop-blur-xl rounded-2xl p-7 mb-8 shadow-lg shadow-black/[0.03] border-t-4 border-t-blue-300 dark:border-t-blue-700/60" translate="no">
      ...
      <div className="notranslate mb-8" translate="no">
        ...
        <AccordionSection title="Salvation & Pre-Tribulation Rapture">
          ...
          <Link
            ...
            className="flex items-center gap-3 p-4 mt-3 rounded-2xl bg-gradient-to-br from-card via-card to-accent/15 border border-accent/25 backdrop-blur-xl shadow-sm hover:shadow-lg hover:border-accent/40 hover:-translate-y-0.5 active:scale-[0.98] transition-all duration-200 group"
          >
            <div className="flex-shrink-0 w-10 h-10 flex items-center justify-center rounded-xl text-white shadow-md bg-gradient-to-br from-rose-500 to-red-600">
      ...
      {/* Links */}
      <div className="bg-gradient-to-br from-card via-card to-accent/15 border border-accent/25 backdrop-blur-xl rounded-2xl p-7 mb-8 shadow-lg shadow-black/[0.03] border-t-4 border-t-emerald-300 dark:border-t-emerald-700/60">
