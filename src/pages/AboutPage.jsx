...
export default function AboutPage() {
  return (
    ...
    <div className="w-full max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 py-10">
      ...
      {/* About Shawn */}
      <ColorSection collapsible edge="from-amber-500 to-orange-500" iconBg="from-amber-500 to-orange-600" icon={<Users className="w-5 h-5" />} title="About the App Creator" className="notranslate" translate="no">
      ...
      <ColorSection collapsible edge="from-blue-600 to-indigo-500" iconBg="from-blue-600 to-indigo-500" icon={<BookOpen className="w-5 h-5" />} title="The Bible Text" className="notranslate" translate="no">
        <p className="font-sans text-foreground/85 leading-relaxed mb-4">
