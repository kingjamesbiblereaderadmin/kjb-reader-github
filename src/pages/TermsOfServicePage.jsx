      ...
      <div className="w-full max-w-3xl mx-auto px-5 sm:px-8 lg:px-12 py-10 pb-24">
        ...
        <Section title="Third-Party Content & Licenses">
          <p>
            ...
            an open-source text-to-speech engine released under the MIT License. The voice model
            used was trained on the <strong className="text-foreground">CSTR VCTK Corpus</strong>
            (University of Edinburgh), an open-licensed speech dataset made available under the
            Open Data Commons Attribution License, which requires attribution.
          </p>
          <p>
