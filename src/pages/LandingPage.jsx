        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="font-sans text-xs text-muted-foreground"><span className="notranslate" translate="no">King James Bible Institute</span> by <span className="notranslate" translate="no">Robert Breaker</span> & <span className="notranslate" translate="no">Robert Potthoff</span> — go deeper in God's Word, for free.</p>
            </div>
            <ArrowRight className="w-4 h-4 text-muted-foreground" />
          </a>
