...
export default function HomePage() {
  ...
  return (
    <div className="min-h-full flex flex-col justify-center bg-gradient-to-br from-background via-accent/10 to-background"
    ...
    >
      ...
      {/* Quick links */}
      <div className="print:hidden grid grid-cols-[repeat(auto-fit,minmax(15rem,1fr))] lg:grid-cols-4 gap-3 sm:gap-4 mb-6 auto-rows-fr mt-2">
