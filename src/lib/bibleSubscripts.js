...
// Key: chapter number (integer). Value: exact PCE verse 1 text, copied verbatim
// (including the traditional chapter-opening caps and per-word [brackets]) from
// the source PCE text file.
