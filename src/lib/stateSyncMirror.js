...
//
// NOTE: this module supersedes src/lib/nativeStateSync.js. The Base44
// builder repeatedly refused to take this file's GitHub version (its local
// copy stayed stale through every conflict resolution), so the
// implementation lives here under a path the builder has never touched.
// Do NOT import from nativeStateSync.js — the builder may compile its
// stale copy. main.jsx imports this module instead.
//
